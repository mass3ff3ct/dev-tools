...
purgeCssFiles = function(targetDir, groupMap) {
  ...
  removePromises = (function() {
    ...
    for (_i = 0, _len = files.length; _i < _len; _i++) {
      relative = files[_i];
      _results.push(Future.call(fs.unlink, "" + targetDir + "/public/" + relative));
    }
    return _results;
  })();
  ...
  return requirejsConfig.collect(targetDir).then(function(requireConfig) {
    ...
    removePromises = (function() {
      ...
      for (_i = 0, _len = files.length; _i < _len; _i++) {
        ...
        _results.push(Future.call(fs.unlink, "" + targetDir + "/public/" + relative + ".js"));
      }
      return _results;
    })();
        ...
        return Future.call(fs.readdir, target).then(function(items) {
          ...
          futures = (function() {
            ...
            for (_i = 0, _len = items.length; _i < _len; _i++) {
              item = items[_i];
              _results.push(purgeEmptyFolders(path.join(target, item)));
            }
            return _results;
          })();
