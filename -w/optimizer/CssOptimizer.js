...
CssOptimizer = (function() {
  ...
  * and so on
  ...
  CssOptimizer.prototype._generateOptimizationMap = function(stat) {
    var corrDetector, group, groupId, groupRepo, groups, heuristicDetector, iterations, page, resultMap, _i, _len, _ref;
    iterations = 1;
  ...
  CssOptimizer.prototype._mergeGroups = function(groupMap) {
    ...
    mergePromises = (function() {
      ...
      for (groupId in groupMap) {
        ...
        _results.push(this._mergeGroup(this._reorderGroupFiles(cssFiles)).spread(function(fileName, existingFiles) {
