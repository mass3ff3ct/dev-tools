...
var HeuristicGroupDetector, generateGroupId, getCountMap, invertStatMap, sha1, _;
...
HeuristicGroupDetector = (function() {
  ...
  HeuristicGroupDetector.prototype.process = function(stat) {
     ...
     */
    var bestGroup, countMap, curStat, i, lengthBefore, m1, m2, maxRank, moduleList, modules, optimizedStat, page, pages1, pages2, pagesByModule, pair, rank, sortedModuleList, _i, _ref;
    curStat = stat;
    while (true) {
      ...
      maxRank = 0;
      pair = void 0;
      for (i = _i = 0, _ref = sortedModuleList.length - 2; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
