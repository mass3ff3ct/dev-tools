  ...
  CompileCoffeeScript.prototype.run = function() {
    ...
    compilePromise = Future.call(fs.readFile, src, 'utf8').then((function(_this) {
      return function(coffeeString) {
        var answer, hasOwnTemplate, inf, js, name, replacement, templatePath;
        ...
        if (inf.isWidget || inf.isBehaviour || inf.isModelRepo || inf.isCollection) {
          ...
          if (inf.isWidget) {
            templatePath = "" + _this.params.baseDir + "/" + dirname + "/" + inf.lastDirName + ".html";
            hasOwnTemplate = fs.existsSync(templatePath) ? 'true' : 'false';
