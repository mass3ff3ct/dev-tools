...
defineFuture = function(_, asapInContext) {
  ...
  Future = (function() {
    ...
    Future.prototype.when = function() {
       ...
       */
      var promise, self, _i, _len, _ref;
      self = this;
      for (_i = 0, _len = arguments.length; _i < _len; _i++) {
        promise = arguments[_i];
        if (!this._locked) {
          this.fork();
        }
        if (promise._noTimeout || !((_ref = global.config) != null ? _ref.debug.future.trackInternalTimeouts : void 0)) {
          self.withoutTimeout();
        }
    ...
    Future.prototype["finally"] = function(callback) {
      ...
      if (this._noTimeout || !((_ref = global.config) != null ? _ref.debug.future.trackInternalTimeouts : void 0)) {
    ...
    Future.any = function(futureList) {
      ...
      @todo maybe need to support noTimeout property of futureList promises
       */
      var f, failCounter, ready, result, _i, _len;
  ...
  recCollectLongStackTrace = function(promise, args) {
    ...
    var _ref;
    if (promise._stack) {
      args.push("\n" + filterStack(promise._stack, promise._name, (_ref = promise._parent) != null ? _ref._stack : void 0));
    }
    if (promise._parent) {
  ...
  initTimeoutTracker = function() {
     ...
     */
    var interval, unhandledTimeout, unresolvedTimeout, _ref, _ref1, _ref2, _ref3;
    unhandledSoftTracking = !!((_ref = global.config) != null ? _ref.debug.future.trackUnhandled.soft : void 0);
    interval = parseInt((_ref1 = global.config) != null ? _ref1.debug.future.trackUnhandled.interval : void 0);
    unhandledTimeout = parseInt((_ref2 = global.config) != null ? _ref2.debug.future.trackUnhandled.timeout : void 0);
    unresolvedTimeout = parseInt((_ref3 = global.config) != null ? _ref3.debug.future.timeout : void 0);
    unhandledMap = {};
    unresolvedMap = {};
    if (interval > 0) {
      return setInterval(function() {
        var curTime, elapsed, err, id, info, pr, reportArgs, state, _results;
        ...
        for (id in unhandledMap) {
          ...
          if (elapsed > unhandledTimeout) {
            ...
            _results.push(delete unhandledMap[id]);
          } else {
  ...
  longStackTraceEnabled = !!((_ref = global.config) != null ? _ref.debug.future.longStackTrace.enable : void 0);
  longStackTraceAppendName = !!((_ref1 = global.config) != null ? _ref1.debug.future.longStackTrace.appendPromiseName : void 0);
  unhandledTrackingEnabled = !!((_ref2 = global.config) != null ? _ref2.debug.future.trackUnhandled.enable : void 0);
  unresolvedTrackingEnabled = !!((_ref3 = global.config) != null ? _ref3.debug.future.timeout : void 0);
